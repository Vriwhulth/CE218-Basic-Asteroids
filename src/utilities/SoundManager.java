...
// method that loads the sound files
    // I decided to load all of the sound files
...
public class SoundManager {
    ...
    public final static Clip shipdead = getClip("shipdead");

    public final static Clip[] clips = {bangLarge, bangMedium, bangSmall, beat1, beat2,
            extraShip, fire, saucerBig, saucerSmall, thrust, powerUp, shipdead};
    ...
    public static void shipDead(){play(shipdead);}
